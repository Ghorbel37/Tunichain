...
/**
 * Workload module for adding banks to the Registry contract.
 */
class AddBank extends OperationBase {
    ...
    /**
     * Assemble TXs for adding new banks.
     */
    async submitTransaction() {
        const args = this.tunichainState.getAddBankArguments();
